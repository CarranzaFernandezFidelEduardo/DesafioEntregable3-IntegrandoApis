...
namespace PrimeraEntrega_ProyectoFinal.Repositories
{
    public class ProductoVendidoRepository
    {
        ...
        public void CrearProductoVendido(int IdProducto, int IdVenta, int Stock)
        {
            SqlConnectionStringBuilder conecctionbuilder = new();
            conecctionbuilder.DataSource = "DESKTOP-KU34FRJ\\MSSSQLSERVER";
            conecctionbuilder.InitialCatalog = "SistemaGestion";
            ...
            var cs = conecctionbuilder.ConnectionString;
                ...
                using (SqlConnection connection = new SqlConnection(cs))
                {
                    ...
                    param2.Value = IdProducto;

                    var param3 = new SqlParameter("idVenta", SqlDbType.Int);
                ...
                productos.ModificarStockDelProducto(Stock, IdProducto);
